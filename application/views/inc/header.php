...
<head>
    ...
    <!-- Site title -->
    <title>Elzara Online Shopping</title>
    <!-- Favicon -->
                ...
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-6 col-6">
                        <div class="logo">
                            ...
                            <img src="<?php echo base_url()?>assets/img/logo/logo_elzara.png" alt="" width="200px" height="50px">
                            </a>
                        </div>
                    </div>
                            ...
                            <div class="main-menu">
                                <nav id="mobile-menu">
                                    <ul>
                                        ...
                                        <li><a href="<?php echo base_url('home/account') ?>">Akun saya</a></li>
